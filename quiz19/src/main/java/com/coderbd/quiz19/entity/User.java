...
public class User {
    ...
    public User(String userName,String password, String firstName, String lastName, String email,String mobile, Date joiningDate, boolean isActivated, String activationKey, String resetPasswordKey, Set<Role> roles) {
